    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <span class="nav-item social-icons">
                <span class="fa-stack">
                    <a href="https://www.instagram.com/iam_d3mon/">
                        <span class="hexagon"></span>
                        <i class="fab fa-instagram fa-stack-1x" style="left: 0px;"></i>
                    </a>
                </span>
                <span class="fa-stack">
                    <a href="https://twitter.com/YouTubeD3MON">
                        <span class="hexagon"></span>
                        <i class="fab fa-twitter fa-stack-1x " style="left: 0px;"></i>
                    </a>
                </span>
            </span>
        </div>
...
text-decoration: none;"><i class="fas fa-envelope"></i> phone4u.
                ...
                <div class="col-md-4">
                    <div class="text-container about">
                        <h4>Locate Us</h4>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.754038472643!2d73.05933931490053!3d19.030556987113986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c24052e100f3%3A0xb6e3e4259b43a898!2sA.%20C.%20Patil%20College%20of%20Engineering!5e0!3m2!1sen!2sin!4v1665417010396!5m2!1sen!2sin" width="100%" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                ...
                <div class="col-md-4">
                    <div class="text-container footer-reach-us">
                        ...
                        <ul class="list-unstyled li-space-lg footer-list">
                            ...
                            <li>
                                <a class="white" href="https://www.instagram.com/iam_d3mon/"><i class="fab fa-instagram"></i></a>
                            </li>
                            <li class="media">
                                <a class="white" href="https://twitter.com/YouTubeD3MON"><i class="fab fa-twitter"></i></a>
                            </li>
                        </ul>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © 2022 <a href="http://gpmumbai.ac.in" style="text-decoration: underline;">Phone4U</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
